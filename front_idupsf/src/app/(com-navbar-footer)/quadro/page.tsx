...
export default async function QuadroHorarios() {
    ...
    const [departamentos, cursos, periodos] = await Promise.all([
        opcoesService.listarDepartamentos(),
        opcoesService.listarCursos(),
        opcoesService.listarPeriodos()
    ]);
    ...
    return (
        <main className={styles.main}>
            ...
            <section className={styles.filtersSection}>
                <QuadroHelper departamentos={departamentos} cursos={cursos} periodos={periodos} />
            </section>
